...
<html lang="en">
  <head>
    ...
    <style>
      .box {
        ...
        <?php
          ...
          // First, fetch all pets data and store in JavaScript-accessible format
          $pets_data = [];
          $query = mysqli_query($cnn, "SELECT * FROM `service` WHERE status='Active'");
    ...
    <div class="k-content">
      <div class="k-add-content">
       <?php include 'header.php'; ?>
        <div class="k-modal">
          <div class="add-btn">
            <h2 class="k-modal-title ps-4"><?php if(isset($_GET['id'])){ echo 'Updated Service Maintain'; } else { echo 'Add Service Maintain'; } ?></h2>
          </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="mb-3">
                    <div class="k-form-group">
                        <label class="k-form-label">Service</label>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div>
                  ...
                  <div class="mb-3">
                    <div class="k-form-group">
                    <label class="k-form-label">Service Date</label>
          ...
          <div class="k-modal-footer">
              <button type="button" class="k-btn-cancel" onclick="window.location.href='service_m.php'">Cancel</button>
    ...
    <script src="js/service_m.js"></script>
    <script>
...
function showSelectedPet() {
    ...
    if (selectedPet) {
        ...
        // Update hidden fields with original price (no discount)
        document.getElementById('billingPriceInput').value = selectedPet.price;
        document.getElementById('totalCostInput').value = selectedPet.price;
...
// Update cost when user changes discount
