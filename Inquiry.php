                      ...
                      <td>' . substr($row['message'], 0, 10) . '...</td> 
                        ...
                        <td class="action-buttons">
                          <a href="#" 
                                ...
                                data-description="' . htmlspecialchars($row['message']) . '"> <!-- Added data-description attribute -->
...
deleteCategoryModal.addEventListener('show.bs.modal', function (event) {
    ...
    const message = `Are you sure you want to delete Inquiry Image?`;
    ...
    deleteButton.onclick = function() {
        fetch(`crud.php?what=delete_inquiry`, {
            method: 'POST',
            headers: {
