    ...
    <style>
     ...
     <?php
          if (isset($_GET['id']) && !empty($_GET['id'])) {
              ...
              $query = mysqli_query($cnn, "select * from service where id=" . $id . "");
              $row = mysqli_fetch_array($query);
              $name = $row['name'];
    ...
    <div class="k-content">
      <div class="k-add-content">
       <?php include 'header.php'; ?>
        <div class="k-modal">
          <div class="add-btn">
            <h2 class="k-modal-title ps-4"><?php if(isset($_GET['id'])){ echo 'Updated Services'; } else { echo 'Add Services'; } ?></h2>
          </div>
          ...
          <div class="row">
                ...
                <input id="txtUId" name="txtUId" value="<?php if (isset($_GET['id'])) {
                    ...
                    <div class="mb-3">
                        <div class="k-form-group">
                                <label class="k-form-label">Service Name</label>
                                <input
                                type="text"
            ...
            <div class="k-modal-footer">
                <button type="button" class="k-btn-cancel" onclick="window.location.href='service.php'">Cancel</button>
