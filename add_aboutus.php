...
<html lang="en">
  ...
  <?php
          if (isset($_GET['id']) && !empty($_GET['id'])) {
              ...
              $query_about = mysqli_query($cnn, "select * from about_us where id=" . $id . "");
    ...
    <div class="k-content">
      <div class="k-add-content">
       <?php include 'header.php'; ?>
        <div class="k-modal">
          <div class="add-btn">
            <h2 class="k-modal-title ps-4"><?php if(isset($_GET['id'])){ echo 'Updated About Us'; } else { echo 'Add About Us'; } ?></h2>
          </div>
          ...
          <div class="row">
            ...
            <button type="button" class="k-btn-cancel" onclick="window.location.href='aboutus.php'">Cancel</button>
