...
<html lang="en">
  ...
  <?php
          if (isset($_GET['id']) && !empty($_GET['id'])) {
              ...
              $query_about = mysqli_query($cnn, "select * from privacy where id=" . $id . "");
    ...
    <div class="k-content">
      <div class="k-add-content">
       <?php include 'header.php'; ?>
        <div class="k-modal">
          <div class="add-btn">
            <h2 class="k-modal-title ps-4"><?php if(isset($_GET['id'])){ echo 'Updated Privacy Policy'; } else { echo 'Add Privacy Policy'; } ?></h2>
          </div>
          ...
          <div class="row">
            <div class="col-sm-12">
                ...
                <button type="button" class="k-btn-cancel" onclick="window.location.href='privacy.php'">Cancel</button>
