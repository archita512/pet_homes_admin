    ...
    <div class="k-content">
      ...
      <div class="k-page-content">
        <div class="k-page-header">
          <div>
            <h4 class="mb-1" style="margin-left: 30px;">Terms & Condtition</h4>
      ...
      <?php
      $query = mysqli_query($cnn, "SELECT * FROM terms ORDER BY id DESC");
      $cnt = 1;
      while ($row = mysqli_fetch_array($query)) {
      $c_id = encryptor('encrypt', $row['id']);
      ?>
      <div class="about-card border rounded p-3 mb-3 bg-white">
          <!-- Top Row: Term (left), Actions (right) -->
          <div class="d-flex justify-content-between align-items-start">
              ...
              <div class="d-flex align-items-center gap-2">
                  ...
                  <a href="add_terms.php?id=<?php echo $c_id; ?>" class="edit-btn">
...
deleteCategoryModal.addEventListener('show.bs.modal', function (event) {
    ...
    const message = `Are you sure you want to delete Terms?`;
