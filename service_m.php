    ...
    <div class="k-content">
      ...
      <div class="k-page-content">
        <div class="k-page-header">
          <div>
            <h4 class="mb-1">Service Maintain</h4>
        ...
        <div class="k-table-container d-flex flex-column justify-content-between">
          <div class="table-responsive">
            <table id="tbl_cat" class="table table-striped table-hover">
              ...
              <tbody>
                <?php
                  $query = mysqli_query($cnn,"SELECT ad.*,p.image FROM `service_maintain` AS ad JOIN `service` AS p ON ad.s_id = p.id ORDER BY ad.id DESC");
                  $cnt = 1;
            ...
            $('#submitPayment').on('click', function () {
              ...
              if (method === "") {
                var toastHTML = `
                        ...
                        $.ajax({
                    url: 'crud.php?what=payment_service',
                    method: 'POST',
                    data: {
                      id: id,
                      status: method
