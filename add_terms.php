...
<html lang="en">
  ...
  <?php
          if (isset($_GET['id']) && !empty($_GET['id'])) {
              ...
              $query_about = mysqli_query($cnn, "select * from terms where id=" . $id . "");
    ...
    <div class="k-content">
      <div class="k-add-content">
       <?php include 'header.php'; ?>
        <div class="k-modal">
          <div class="add-btn">
            <h2 class="k-modal-title ps-4"><?php if(isset($_GET['id'])){ echo 'Updated Terms & Condtitions'; } else { echo 'Add Terms & Condtitions'; } ?></h2>
          </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="k-form-group">
                    ...
                    <div class="k-form-group">
                     ...
                     <textarea name="des" id="des" class="k-form-control" rows="3" placeholder="Descrition"><?php if(isset($_GET['id'])){ echo $des; } ?></textarea>
                    <br><br>
                </div>
                </div>
              </div>
                ...
                <button type="button" class="k-btn-cancel" onclick="window.location.href='terms.php'">Cancel</button>
